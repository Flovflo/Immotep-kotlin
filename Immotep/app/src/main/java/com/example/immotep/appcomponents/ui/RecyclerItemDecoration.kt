 ...
 * @param includeEdge to include edge spacing
 */
class RecyclerViewItemDecoration(
        ...
        when (displayMode) {
            ...
            GRID -> if (layoutManager is GridLayoutManager) {
                ...
                if (includeEdge) {
                    ...
                    outRect.top = if (position / spanCount == 0) spacing else 0
                    outRect.bottom = 0
                }
            }
    ...
    private fun resolveDisplayMode(layoutManager: RecyclerView.LayoutManager?): Int {
        return when (layoutManager) {
            ...
            else -> if (layoutManager?.canScrollHorizontally() == true) HORIZONTAL else VERTICAL
        }
    }
